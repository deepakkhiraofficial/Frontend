        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col gap-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link to="/marketing" className="hover:text-indigo-400">
                                    Marketing
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/automation" className="hover:text-indigo-400">
                                    Automation
                                </Link>
                            </li>
                            <li>
                                <Link to="/commerce" className="hover:text-indigo-400">
                                    Commerce
                                </Link>
                            </li>
                            <li>
                                <Link to="/insights" className="hover:text-indigo-400">
                                    Insights
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li>
                                <Link to="/docs" className="hover:text-indigo-400">
                                    Documentation
                                </Link>
                            </li>
                            <li>
                                <Link to="/guides" className="hover:text-indigo-400">
                                    Guides
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li>
                                <Link to="/license" className="hover:text-indigo-400">
                                    License
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center text-sm border-t border-gray-700 pt-6">
                    <p className="text-gray-400 mb-4 sm:mb-0">© 2024 MyShop. All rights reserved.</p>
